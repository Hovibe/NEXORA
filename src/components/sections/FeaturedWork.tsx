      ...
      <div className="max-w-7xl mx-auto">
        <Reveal>
          <SectionHeading
            ...
            description="Real projects. Real problems. Real solutions."
          />
        </Reveal>
                  ...
                  <div className="relative h-64 md:h-80 bg-gradient-to-br from-nexora-charcoal via-nexora-dark to-nexora-black overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative w-full h-full p-8 md:p-12">
                        ...
                        <div className="absolute top-20 md:top-26 left-12 md:left-16 w-20 md:w-28 h-1.5 md:h-2 bg-nexora-muted/50 rounded" />
                        ...
                        <div className="absolute bottom-16 md:bottom-20 right-16 md:right-20 w-12 md:w-16 h-8 md:h-10 rounded-lg bg-nexora-blue/5 border border-nexora-blue/10" />
